...
from kimetto.app import create_app
from kimetto.database import db
from kimetto.settings import DevConfig, ProdConfig
from kimetto.user.models import User

CONFIG = ProdConfig if os.environ.get('KIMETTO_ENV') == 'prod' else DevConfig
